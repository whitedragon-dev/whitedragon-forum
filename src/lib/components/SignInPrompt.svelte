...
<div
	class="flex flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-fd-border py-20 text-center"
>
	<svg class="size-10 text-fd-muted-foreground" viewBox="0 0 16 16" fill="currentColor">
		<path
